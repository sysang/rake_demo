...
def noun_chunks(doclike: Union[Doc, Span]) -> Iterator[Span]:
    ...
    conj = doc.vocab.strings.add("conj") # a representative number for conj
    nmod = doc.vocab.strings.add("nmod") # a representative number for conj
    obj = doc.vocab.strings.add("obj") # a representative number for conj
    case = doc.vocab.strings.add("case") # a representative number for conj
    np_label = doc.vocab.strings.add("NP") # a representative number for NP
    ...
    for i, word in enumerate(doclike):
        print("\n-  {}".format(word))
        print("\t{}..[{}]; (dep)[{}, {}]; (head){}".format(word.left_edge.i, word.i, word.dep, word.dep_, word.head))
        ...
        #     head = word.head
            ...
            if word.head.dep == obj and word.left_edge.dep == case:
                prev_end = word.i
